...
<?php
                    ...
                    if (!isset($_SESSION['usernamein'])) {
                        ...
                        <li class="nav-item active">
                        <form action="godfather.php" method="POST" class="nav-link">
  ...
  <div class="col-md-4">
    ...
    <h3 class="my-3">
        ...
        <h6>Official Sites:
            ...
            <span>|</span>
            <a href="" rel="nofollow" itemprop="ur1">See more</a>
            &nbsp;››
        </h6>

        <h6>Country:
            <a href="" rel="nofollow" itemprop="ur1">USA</a>
            <span>|</span>
            <a href="" rel="nofollow" itemprop="ur1"> Germany </a>

        </h6>

        <h6>Language:
            <a href="" rel="nofollow" itemprop="ur1">English</a>
            <span>|</span>
            <a href="" rel="nofollow" itemprop="ur1"> German </a>
            <span>|</span>
            <a href="" rel="nofollow" itemprop="ur1"> Xhosa  </a>
            <span>|</span>
            <a href="" rel="nofollow" itemprop="ur1"> Russian </a>
            <span>|</span>
            <a href="" rel="nofollow" itemprop="ur1"> Romanian </a>
            <span>|</span>
            <a href="" rel="nofollow" itemprop="ur1"> Hindi </a>
        </h6>

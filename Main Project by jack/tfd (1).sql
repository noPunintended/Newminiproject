...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2017 at 08:17 AM
...
INSERT INTO `foods` (`food_id`, `name`, `price`, `image`, `description`, `comment`) VALUES
...
INSERT INTO `wishlist` (`wishlist_id`, `cu_id`, `food_id`) VALUES
(1, 1, 4),
(2, 1, 8),
(3, 1, 2);

...
<header class="bgimg w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-bottomleft w3-padding">
    <span class="w3-tag w3-xlarge">Open 24 hr</span>
  </div>
  <div class="w3-display-middle w3-center">
    <span class="w3-text-white w3-hide-small" style="font-size:110px">Rubicon Express</span>
    <span class="w3-text-white w3-hide-large w3-hide-medium" style="font-size:60px"><b>THAI FOOD<br>DELIVERY</b></span>
    <p><a href="food.php" class="w3-button w3-xxlarge w3-black">Let's start shopping</a></p>
  </div>
</header>
